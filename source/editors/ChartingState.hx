...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['PeaTransit', "Only used to add extra detail to the gatling\nbefore switching characters\nUsing this elsewhere may result in crashing the game."],
		...
		['Trigger Green light', "Make a funkin' party with the green light!"],
		['Trigger Purple light', "Make a funkin' party with the purple light!"],
		['Trigger Green light CON', "Use this after the last light was called. \nThe imps didn't code the light thingy right!"],
		['Trigger Purple light CON', "Use this after the last light was called. \nThe imps didn't code the light thingy right!"]
	];
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		DiscordClient.changePresence("Charting the Brainz!", StringTools.replace(PlayState.SONG.song, '-', ' '));
